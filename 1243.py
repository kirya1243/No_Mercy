...
def DrawWindow():
    ...
    screen.blit(load_image("Raul_l0.png"), (1147, 455))
    screen.fill(pygame.Color('red'), pygame.Rect(10, 10, 200, 20))
    screen.fill(pygame.Color('green'), pygame.Rect(10, 10, 200 - damage, 20))
...
while running:
    ...
    if (keys[pygame.K_RIGHT] or keys[pygame.K_d]) and x < 1147:
        x += speed
        if damage < 189:
            damage += 1
        right = True
